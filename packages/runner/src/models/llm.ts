...
export const openaiModels: Model[] = [
 ...
 {
   // Older 4.x / 3.5 chat models (kept for compatibility)
   category: 'gpt-4.x / 3.5',
   comment: 'older chat models (compat / legacy)',
   models: [
     { name: 'gpt-4-turbo',   comment: 'legacy but still in model list' }, // :contentReference[oaicite:10]{index=10}
     { name: 'gpt-4',         comment: 'legacy 4.x' },
     { name: 'gpt-3.5-turbo', comment: 'legacy 3.5' },
   ],
 },
 {
